...
- Le bâtiment est posé sur une **crête montagneuse**, entre deux versants.
- À gauche se trouve un **glacier extrêmement haut**.
- À droite coule de la **vraie lave** issue du versant volcanique.
- Le fort n'est **pas au sommet** de la montagne : il est implanté plus bas sur la crête.
- La glace et la lave se rencontrent en contrebas.
- Leur rencontre crée continuellement de la vapeur, de la fumée et de la brume.
- La zone de contact produit des **formations rocheuses instables**.

## Ton recherché

- Impressionnant et spectaculaire.
- Coloré malgré l'aspect carcéral.
- Fantastique, mais avec des reliefs, des matières et une implantation crédibles.
- Marqué par le contraste bleu-blanc de la glace et rouge-noir du magma.
- La brume n'est pas un simple décor : elle est une conséquence permanente de la rencontre des deux milieux.
