...
- [Rez-de-chaussée](rez-de-chaussee.md)
- [Niveau 2 — galerie des personnages](niveau-02-galerie.md)
- [Niveau 3 — étage de glace](niveau-03-glace.md)
- [Niveau 4 — le sol, c'est de la lave](niveau-04-lave.md)

La désignation « niveau 3 » est déduite de l'ordre de la conversation et doit encore être confirmée.

## Principes de conception des cartes

- Préserver la forme circulaire du fort.
- Produire des cartes plus grandes, réalistes et soignées.
- Donner des noms aux pièces et aux épreuves.
